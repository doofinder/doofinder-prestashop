...
{if isset($search_engine_id) && $search_engine_id}
  ...
  <script type="text/javascript" defer="" src="https://{$df_region|escape:'htmlall':'UTF-8'}-search.doofinder.com/5/script/{$search_engine_id|escape:'htmlall':'UTF-8'}.js"></script>
